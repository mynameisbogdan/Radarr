...
import styles from './TheMovieDatabase.css';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.info}>
        <div className={styles.title}>TheMovieDB</div>
        <InlineMarkdown
          data={translate('MovieInformationIsProvidedByTMDB', {
            url: 'https://www.themoviedb.org/subscribe',
          })}
        />
      </div>
    </div>
